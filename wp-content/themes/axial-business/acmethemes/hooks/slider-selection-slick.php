                        ...
                        <div class="item" style="<?php echo $bg_image_style; ?>">
                            ...
                            <div class="slider-content <?php echo esc_attr( $text_align );?>">
                                <!--div class="container"-->
									...
									if( FALSE && 1 == $construction_field_feature_slider_image_excerpt ){
										?>
									...
									if( FALSE && !empty( $slides_single_data['button-1-text'] ) ){
										?>
									...
									if( FALSE && !empty( $slides_single_data['button-2-text'] ) ){
										?>
