...
if ( ! function_exists( 'construction_field_setup' ) ) :
    ...
    function construction_field_setup() {
         ...
         * If you're building a theme based on Axial Business, use a find and replace
...
function construction_field_scripts() {
    ...
    wp_enqueue_style( 'colorbox', get_template_directory_uri() . '/assets/library/colorbox/colorbox.css', array(), '1.3.3' );
    wp_enqueue_script('colorbox', get_template_directory_uri() . '/assets/library/colorbox/jquery.colorbox-min.js', array('jquery'), '1.3.2', 1);
    ...
    wp_enqueue_script('isotope', get_template_directory_uri() . '/assets/library/isotope/isotope.pkgd.min.js', array('jquery'), '1.1.0', 1);
