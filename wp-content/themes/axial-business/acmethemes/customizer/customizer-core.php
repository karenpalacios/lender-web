...
if ( !function_exists('construction_field_get_default_theme_options') ) :
    function construction_field_get_default_theme_options() {
        ...
        $default_theme_options = array(
	        ...
	        'construction-field-menu-right-button-title'        => esc_html__('Call Us','construction-field'),
	        ...
	        /*theme options*/
            'construction-field-popup-widget-title'     => esc_html__( 'Call Us', 'construction-field' ),
